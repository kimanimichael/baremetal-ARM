rm -rf build/
mkdir build/
arm-none-eabi-gcc -O0 -g -Wall -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -c -o build/startup.o startup/startup.c
arm-none-eabi-gcc -O0 -g -Wall -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -c -o build/bsp.o src/bsp.c
arm-none-eabi-gcc -O0 -g -Wall -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -c -o build/delay.o src/delay.c
arm-none-eabi-gcc -O0 -g -Wall -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -c -o build/system_stm32f4xx.o core/system_stm32f4xx.c
arm-none-eabi-gcc -O0 -g -Wall -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -c -o build/main.o src/main.c
